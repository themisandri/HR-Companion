        ...
        try{
           ...
           if (rs.next()){
            ...
            if(jComboBox1.getSelectedIndex()==0){
               ...
               GeneralManagerForm g = new GeneralManagerForm(txtuser.getText());
               g.setVisible(true);
               this.setVisible(false);
            }
            else if(jComboBox1.getSelectedIndex()==2){
               RegionalManagerForm r = new RegionalManagerForm(txtuser.getText());
               r.setVisible(true);
               this.setVisible(false);
            }
            else if(jComboBox1.getSelectedIndex()==3){
               EmployeeForm e = new EmployeeForm(txtuser.getText());
               e.setVisible(true);
               this.setVisible(false);
            }
            else if(jComboBox1.getSelectedIndex()==4){
               ClientForm c = new ClientForm(txtuser.getText());
               c.setVisible(true);
               this.setVisible(false);
            }
            }
