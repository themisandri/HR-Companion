...
public class EmployeePerformance extends Performance{
    ...
    private int technical_knowledge,productivity,deadlines,quality_of_work,teamwork,communication_skills,improvement,id;
    private String written_report;
    
    public EmployeePerformance (int overal_score, String date,int technical_knowledge, int productivity, int deadlines, int quality_of_work, int teamwork, int communication_skills, int improvement,int id)
    {
