...
public class RegionalManager extends User{
	...
	public RegionalManager (boolean promotion_match,String feedback,String leave, int id, String username, String password,String type, String name, String email, String gender)
	{
