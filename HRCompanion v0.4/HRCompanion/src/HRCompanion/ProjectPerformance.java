...
public class ProjectPerformance extends Performance {
    ...
    double cost;
    int id,time, percent_of_specs_met;
    
    public ProjectPerformance (int id,int overal_score, String date,String questionnaire,String comments,double cost,int time, int percent_of_specs_met )
    {
