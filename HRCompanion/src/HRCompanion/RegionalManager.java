...
public class RegionalManager extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabelExit, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 730, 70, 60));
        ...
        getContentPane().add(jLabelClientButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 550, 180, 40));
        ...
        getContentPane().add(jLabelViewPerfButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 410, 230, 40));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 50, 1000, 430));

        FeedScreen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/HRCompanion/images/Reg Feed.jpg"))); // NOI18N
        ...
        getContentPane().add(Feed, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 610, 180, 40));

        Rate.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        getContentPane().add(Rate, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 480, 190, 40));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/HRCompanion/images/regional (2).jpg"))); // NOI18N
